...
top_review <- head(reviews, 1)
headline <- top_review[["headline"]]
short_summary <- top_review[["summary_short"]]
link <- top_review[["link.url"]]

# Create a list of the three pieces of information from above. 
# Print out the list.
review_data <- list("headline" = headline, "short summary" = short_summary, "link" = link)
print(review_data)
